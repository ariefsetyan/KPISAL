 ...
 <script type="text/javascript" src="/md5.js"></script>
   <div class="container" id="login-block">
        <div class="row">
          <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
            ...
            <div class="login-logo">
                 ...
                 <h5 class="centered">Farmasi Dinas Kesehatan Surabaya</h5>
                </div> 
                <hr />
                <div class="login-form">
              <form id="form_id" name="login" action="import_php_mysqli/index.php" method="post">
      ...
      <footer class="container">
        <p id="footer-text">Copyright &copy; STIKOM SURABAYA 2018</p>
      </footer>
